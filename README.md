...
<!--
    This is the CI badge image:
        ...
        `/emma-char/swp25-tutorial/` - owner/repository
...
-->
[1]: https://img.shields.io/github/actions/workflow/status/emma-char/swp25-tutorial/ci_linux.yml?branch=main&style=flat&logo=github&label=swp25-tutorial%20CI "Open GitHub actions page"
<!--
    This is the CI badge link:
        `https://github.com/emma-char/swp25-tutorial/actions` - actions page of owner/repository
        `?query=branch%3Amain` - only show actions that ran on the mater branch
-->
[2]: https://github.com/emma-char/swp25-tutorial/actions?query=branch%3Amain
<!--
    This is the Codecov badge image:
        Codecov offers badges: https://app.codecov.io/gh/emma-char/swp25-tutorial/settings/badge
        While being logged in into Codecov, navigate to Settings->Badge and copy the markdown badge.
        Copy the image part of the markdown badge here.
    `"Open Codecov page"` - this text will be shown on hover
-->
[3]: https://codecov.io/gh/emma-char/swp25-tutorial/branch/main/graph/badge.svg "Open Codecov page"
<!--
...
-->
[4]: https://codecov.io/gh/emma-char/swp25-tutorial
...
3. **Clone** your repository locally: `git clone git@github.com:emma-char/swp25-tutorial.git`
...
1. Go to https://codecov.io/gh/emma-char/swp25-tutorial.
2. Sign in with your GitHub account.
3. Go to https://app.codecov.io/gh/emma-char/swp25-tutorial/config/general.<br>
   If the repository cannot be found, go to https://app.codecov.io/gh/emma-char and click `Resync`.<br>
   Then try again.
4. Copy the `Repository Upload Token`.
5. Go to https://github.com/emma-char/swp25-tutorial/settings/secrets/actions.
